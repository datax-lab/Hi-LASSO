...
for data in dataset_names:    
    ...
    for iter_num in range(n_iter):
        ...
        rrlasso = recursive_random_lasso.RecursiveRandomLasso(X, y, random_state=random_state)
        rrlasso.fit(X, y)     
        
        end_time = time.time()
        
        record.record_result(record_path, method, beta, beta_hat=rrlasso.coef_, exec_time=end_time-start_time)
